...
import com.asiainfo.jdbc.JDBCHelper;
...
//		System.out.println(testUser.get("name") + ":" + testUser.get("age"));     
		...
		// 测试批量执行SQL语句
		String sql = "insert into temp2(phone,day_id) values(?,?)"; 
		
		List<Object[]> paramsList = new ArrayList<Object[]>();
		paramsList.add(new Object[]{"110", 20180801});
		paramsList.add(new Object[]{"123", 20180802});
